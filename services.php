    ...
    <div class="container" style="justify-content: center;">
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo '<a href="form_pemesanan.php'.'" class="btn" style="background-color: #4CAF50; color: white; padding: 10px 20px; border-radius: 5px;">Pesan Sekarang!</a>';
                echo '<br>';
                echo '<a href="edit_card.php?id='. $row["id"].'" class="btn btn-warning" style="background-color: #FFA500; color: white; padding: 10px 20px; border-radius: 5px;">Edit</a>';
                echo '<br>';
                echo '<a href="delete_card.php?id='.$row["id"].'" class="btn btn-danger" style="background-color: #FF0000; color: white; padding: 10px 20px; border-radius: 5px;">Hapus</a>';
                echo '</div>';
            }
        } else {
